...
if (!isset($_SESSION['reset_email_customer'])) {
...
<html>
<head>
<title>Verify OTP - Customer</title>
<style>
...
if (isset($_POST['verify'])) {
    ...
    if (mysqli_num_rows($result) == 1) {
        ...
        echo "<script>setTimeout(function(){ window.location='create_new_password_customer.php'; }, 1500);</script>";
    } else {
...
<br>
<center><a href="forgot_password_customer.php">Back</a></center>
</div>
